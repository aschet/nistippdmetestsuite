...
void Executor::initExecutionList()
{
  ExecutionList[0]  = 0;
  ExecutionList[1]  = 0;
  ExecutionList[2]  = &Executor::executeAbortE;
  ExecutionList[3]  = &Executor::executeAlignPart;
  ExecutionList[4]  = &Executor::executeAlignTool;
  ExecutionList[5]  = &Executor::executeCenterPart;
  ExecutionList[6]  = &Executor::executeChangeTool;
  ExecutionList[7]  = &Executor::executeClearAllErrors;
  ExecutionList[8]  = &Executor::executeDisableUser;
  ExecutionList[9]  = &Executor::executeEnableUser;
  ExecutionList[10] = &Executor::executeEndSession;
  ExecutionList[11] = &Executor::executeEnumAllProp;
  ExecutionList[12] = &Executor::executeEnumProp;
  ExecutionList[13] = &Executor::executeEnumTools;
  ExecutionList[14] = &Executor::executeFindTool;
  ExecutionList[15] = &Executor::executeGet;
  ExecutionList[16] = &Executor::executeGetChangeToolAction;
  ExecutionList[17] = &Executor::executeGetCoordSystem;
  ExecutionList[18] = &Executor::executeGetCsyTransformation;
  ExecutionList[19] = &Executor::executeGetDMEVersion;
  ExecutionList[20] = &Executor::executeGetErrorInfo;
  ExecutionList[21] = &Executor::executeGetErrStatusE;
  ExecutionList[22] = &Executor::executeGetMachineClass;
  ExecutionList[23] = &Executor::executeGetProp;
  ExecutionList[24] = &Executor::executeGetPropE;
  ExecutionList[25] = &Executor::executeGetXtdErrStatus;
  ExecutionList[26] = &Executor::executeGoTo;
  ExecutionList[27] = &Executor::executeHome;
  ExecutionList[28] = &Executor::executeIsHomed;
  ExecutionList[29] = &Executor::executeIsUserEnabled;
  ExecutionList[30] = &Executor::executeLockAxis;
  ExecutionList[31] = &Executor::executeOnMoveReportE;
  ExecutionList[32] = &Executor::executeOnPtMeasReport;
  ExecutionList[33] = &Executor::executeOnScanReport;
  ExecutionList[34] = &Executor::executePtMeas;
  ExecutionList[35] = &Executor::executeReQualify;
  ExecutionList[36] = &Executor::executeScanInCylEndIsPlane;
  ExecutionList[37] = &Executor::executeScanInCylEndIsSphere;
  ExecutionList[38] = &Executor::executeScanInPlaneEndIsCyl;
  ExecutionList[39] = &Executor::executeScanInPlaneEndIsPlane;
  ExecutionList[40] = &Executor::executeScanInPlaneEndIsSphere;
  ExecutionList[41] = &Executor::executeScanOnCircle;
  ExecutionList[42] = &Executor::executeScanOnCircleHint;
  ExecutionList[43] = &Executor::executeScanOnLine;
  ExecutionList[44] = &Executor::executeScanOnLineHint;
  ExecutionList[45] = &Executor::executeScanUnknownHint;
  ExecutionList[46] = &Executor::executeSetCoordSystem;
  ExecutionList[47] = &Executor::executeSetCsyTransformation;
  ExecutionList[48] = &Executor::executeSetProp;
  ExecutionList[49] = &Executor::executeSetTool;
  ExecutionList[50] = &Executor::executeStartSession;
  ExecutionList[51] = &Executor::executeStopAllDaemons;
  ExecutionList[52] = &Executor::executeStopDaemon;
  ExecutionList[53] = &Executor::executeTiltCenterPart;
  ExecutionList[54] = &Executor::executeTiltPart;
}
